...
** Note ** You can download the required perl scripts from https://github.com/summanlp/evaluation/tree/master/ROUGE-RELEASE-1.5.5 Once you download create a settings.ini file and inside that create
```
[pyrouge settings]
